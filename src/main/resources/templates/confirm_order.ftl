...
<div class="wrapper-list">
        ...
        <dd>
            <dl>
                ...
                <dd class="kv-line-r dd-padding">
                    <h6>总额：</h6>
                    <p>
                        <strong class="color-stronger highlight-price">${amount}元</strong>
                    </p>
                </dd>
            </dl>
        </dd>
    ...
    <div id="pay-methods-panel" class="pay-methods-panel">
        <div class="wrapper buy-wrapper">
            ...
            <a href=${toUrl} class="J-btn-submit btn mj-submit btn-strong btn-larger btn-block">确认支付</a>
        </div>

    </div>
</div>
<input id="orderId" type="hidden" value=${checkUrl} />
<script type="text/javascript" src="/sell/js/ap.js"></script>
<script>
